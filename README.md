...
- Uso de tecnologias BERT, Sentence Transformers para aprimorar a compreensão semântica e a precisão das respostas.
- Uso de técnicas de NLP para extrair entidades e relacionamentos relevantes das consultas do usuário, facilitando a identificação precisa das fotos correspondentes.
